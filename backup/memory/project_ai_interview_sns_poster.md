...
**📣DB保存は1PF=1レコード**:
- Instagram版 → multi_select [Instagram] 1件
- Facebook版 → [Facebook] 1件
- Threads版 → [Threads] 1件
- X版 → [X] 1件
- → デフォルト4レコード（部分指定時はその分）

**Why**: sns-content-creator(7媒体)が既に媒体別最適化を採用しており、ai-interview-sns-poster だけ共用方式は整合性がなかった。voice-dna §6 の媒体別パターンに完全準拠する形に再設計。
