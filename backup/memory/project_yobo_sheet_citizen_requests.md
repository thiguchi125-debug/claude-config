...
- **台帳の実体URL（正）**: https://docs.google.com/spreadsheets/d/1-qocheanDQRcyUqsixp9EU3Qz6BltTPTbGzfl83cOJ8/edit ＝ Apps Scriptが変換生成した「市民要望管理台帳_v1」。Drive上の **xlsx `1x2Ut5GH68JZKGI9qq77aNOOjNndgXt9O` は変換元の抜け殻**（9/6に草川がこれを開いて「変わってない」と誤認）。案内するときは必ず上のURL。xlsxは別名化 or ゴミ箱の承認待ち
