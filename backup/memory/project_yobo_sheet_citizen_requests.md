...
- 9/7 期限振り直し（草川「台帳の日程調整も必要」）: 9/14×30・9/19×27の固まりを担当課バッチへ。9/13 KY-074補記／9/15 建設部6／9/16 教育民生系5（委員会日）／9/17 建設管理課・道路管理者6／9/18 市担当課ほか6（通告締切で登庁）／9/19 自治会・依頼者への電話9（据え置き）／9/22 県3／9/24 建設系の回答回収8／9/25 教育総務・消防・文化ほか回収10（予算決算委員会日）。ミラーは3日窓なので各バッチは3日前からTodoistに出る。yobo.py の一括更新は `YOBO_NO_MIRROR=1` で写しを止めて最後に1回 `yobo_mirror.py`
