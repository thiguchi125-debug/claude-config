...
- [フォーム回答の属性帰属を推定しない](feedback_form_response_no_attribution_guess.md) — 「アレルギー・体調・配慮事項」等の主語が書かれない自由回答を「お子さま／お母さま」のどちらかと断定しない、返信本文で1行確認＆運営内資料は「どなたの分か要確認」明示（2026-05-19 温泉で産後ケア事故）
