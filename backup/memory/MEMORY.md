...
- [9月議会 一般質問2026-09](project_ippan_shitsumon_2026-09.md) — 本番9/10・11。議場カードv4＝注記全件反映・資料5点(資料4未作成)。未確定＝通告書の版(件名4)・実値照会
...
- [市民要望管理台帳(Googleシート)](project_yobo_sheet_citizen_requests.md) — 稼働中。9/7棚卸し後の食い違い69件修正済。残＝草川手番＝報告3件の回答メモ(9/9)・相手先要確認9件
