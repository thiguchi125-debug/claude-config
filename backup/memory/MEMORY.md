...
- [ohayo停止セクション残骸の自動削除（v2.5-b）](feedback_ohayo_stale_display_removal.md) — 書込停止セクションがダッシュボードに古い表示で残る副作用への対策。毎朝Step 4開始時に10セクション分のスイープを実行し空置換削除（2026-05-13 草川直接指示）
