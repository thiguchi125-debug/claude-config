...
- **箱の骨組み構築済（2026-06-14）**: トップ8領域＝Inbox／🗳選挙2026／🏛議員活動／📋政策・議会／🎪地域・イベント／📣発信／🏡家族・プライベート／🗂構想バックログ。サブPJ＝🗳[9地区訪問・選挙運営人材確保]／🏛[南部地区/井田川地区 市民相談・羽若NT道路安全・菅内〜オークワ歩道・中部中通学路・楠平尾地区フォロー＋§単発の市民要望]／📋[中学校給食・夏季学校体育館環境整備・子育てサロン×まち協・住宅政策・鉄道都市戦略＋§直近議会]／🎪[コスモス2026・🎮eスポーツ(§協会/夏祭り合同8月/井田川小教室/忍山神社9/13)・中庄町お祭り8/15・産後ケア・スケートパーク・まちづくり団体]。線引き＝🏛個別解決／📋議会論点化(政策の種)。**削除＝後援会DB運用/投票区分析/空家法人/JC大市/三松クラブ(完了)**。
- **第1便タスク移行 完了（2026-06-14）**: Notionタスクview 1ページ目の未完了64件を各箱へ投入（エラー0）。eスポ8件と合わせ約72タスク。除外＝Done/Archive・中止PJ・自動生成週次選挙レビュー・【未確認自動抽出】・削除PJ系（空家法人/三松クラブ/JC大市/後援会DB運用/投票区分析）。
- **全タスク移行 完了（2026-06-14）**: Notionタスクview 4ページ分の未完了を全反映＝**Todoist総183件**（🏛議員活動60／🎪地域イベント68／🗳選挙2026 24／📋政策議会11／🗂バックログ12／Inbox+📣8）。除外＝Done/Archive・中止PJ・自動生成週次レビュー・空家法人/三松クラブ(完了)/JC大市/後援会DB/投票区分析・「👹」等ゴミ断片。5ページ目以降は2025-11〜2026-01の完了済イベント最古層のため移行せず（ゴミ化回避・草川合意）。
- **草川がアプリで箱を直接編集**（ライブ反映）＝「羽若NT→羽若 道路安全」「中部中→中部中 スパイラルガーデン通学路」リネーム＋「山下太陽光」「サル対策」箱を新設。Claudeは毎回API実読で追従。
- **残作業**:
  1. **期限超過の棚卸し**（Notion由来で期限5〜6月のまま大量。実は済の照会多数）。アプリで直接チェック/再設定が最速（草川合意）。「監査して」「おはよう」で最新反映。
  2. Todoist安定後、Notion✅タスクDB/🗂️PJDBをアーカイブ（草川判断・元データは保全）。
