...
| # | タイトル | fileId | 期間 | 件数 |
|---|---|---|---|---|
| 1 | 【2025アンケート】市政へのご意見（回答） | 1F-zNtaJPyD8XRM_UYcajsSGnuONG9afEX5VfBBsth5k | 2025/7〜2026/8 | 52件 |
...
| **計** | | | **2021/06〜2026/08** | **410件（=359＋増分51・テスト3件除外）** |

## ドメイン別件数

| ドメイン | 件数 | ファイル |
|---|---|---|
| childcare_education（子育て・教育） | 171 | childcare_education.md |
