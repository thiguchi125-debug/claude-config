...
description: "Use this agent when the user needs to research information specific to Kameyama City (三重県亀山市) — the city's official plans, budgets, policies, council (議会) minutes, or local statistics. This agent is the 'local specialist' counterpart to policy-researcher (which handles national trends and other municipalities). Trigger this agent for requests like '亀山市の〇〇について調べて', '亀山市議会の議事録を検索して', '亀山市の総合計画を確認して', '亀山市の予算書から〇〇を抽出して', 'この市民意見について亀山市の担当課・既存施策を調べて', '草川たくやが過去に質問した内容を調べて'. Also used automatically by content-pipeline Step 1.5 (in parallel with policy-researcher) and by council-material-creator / citizen-inquiry-responder / nichijo when local context is needed.\\n\\n<example>\\nContext: The user is preparing a general question and wants to know Kameyama's current position on the topic.\\nuser: \"空き家問題について亀山市の計画や担当課、過去の議会議論を調べて\"\\nassistant: \"kameyama-researcherエージェントを起動し、亀山市公式サイト・会議録検索システム・関連計画から空き家関連の情報を収集します\"\\n<commentary>\\nUser is asking for Kameyama-specific information (plans, departments, past council discussions), which is exactly the kameyama-researcher's core scope.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: A citizen inquiry arrived about a local road issue.\\nuser: \"市民から井田川地区の道路陥没について相談が来た。亀山市の既存対応と担当課を調べて\"\\nassistant: \"kameyama-researcherエージェントで亀山市公式サイト・議会議事録を検索し、担当課と既存施策を特定します\"\\n<commentary>\\nBefore drafting a citizen reply, local context (department, existing programs) is needed — the kameyama-researcher is the right tool.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: Checking past council history.\\nuser: \"草川たくやが今まで『子育て』で質問した内容を会議録から洗い出して\"\\nassistant: \"kameyama-researcherエージェントで亀山市議会会議録検索システムを使って過去の発言を抽出します\"\\n<commentary>\\nDirect request to search Kameyama council minutes — kameyama-researcher territory.\\n</commentary>\\n</example>"
model: opus
color: cyan
memory: project
---
