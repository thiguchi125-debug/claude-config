...
**評価項目**:
- kusagawa_archive/themes/ 配下の該当テーマファイルとの整合
...
### 検証時の必須参照
- `~/.claude/agents/knowledge/kusagawa_archive/themes/` 配下（過去主張）
