...
4. **`~/.claude/agents/knowledge/kusagawa_archive/voice-dna.md`** を読む（草川の声を絶対保つ）
5. **`~/.claude/agents/knowledge/kusagawa_archive/policy_compass.md`** を読む（軸3「学ぶ亀山から、選ばれる亀山へ」等の引用元）
