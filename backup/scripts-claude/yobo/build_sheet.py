...
STATUS = ["これから聞く","返事待ち","相談者に報告","様子見","完了"]  # 2026-09-06 案A
...
lines = [
 ...
 "■ ステータス：これから聞く（まだ相手に投げていない）／返事待ち（投げた・答えを待つ）／相談者に報告（答えは来た・相談者にまだ伝えていない）／様子見（理由をメモに1行）／完了",
...
out = os.path.join(out_dir, "市民要望管理台帳_v1.xlsx"); wb.save(out); print("saved", out, len(R), "rows")
